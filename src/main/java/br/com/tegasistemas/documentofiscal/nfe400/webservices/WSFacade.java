...
import br.com.tegasistemas.documentofiscal.nfe400.classes.evento.epec.NFEnviaEventoEpecRetorno;
...
import br.com.tegasistemas.documentofiscal.nfe400.classes.evento.manifestacaodestinatario.NFProtocoloEventoManifestacaoDestinatario;
import br.com.tegasistemas.documentofiscal.nfe400.classes.evento.manifestacaodestinatario.NFTipoEventoManifestacaoDestinatario;
...
import br.com.tegasistemas.documentofiscal.nfe400.classes.lote.envio.*;
...
import br.com.tegasistemas.documentofiscal.nfe.webservices.distribuicao.WSDistribuicaoNFe;
...
public class WSFacade {
    ...
    public NFLoteEnvioRetornoDadosNew enviaLoteString(final String lote, final DFModelo modelo, boolean validarXML) throws Exception {
        return this.wsLoteEnvio.enviaLoteXML(lote, modelo, validarXML);
    }
    ...
    public NFLoteEnvioRetornoDadosNew enviaLoteString(final String lote, final DFModelo modelo) throws Exception {
        return enviaLoteString(lote, modelo, true);
    }
     ...
     * o sefaz
     */
    public NFStatusServicoConsultaRetorno consultaStatus(final DFUnidadeFederativa uf, final DFModelo modelo, final NFTipoEmissao tpEmis) throws Exception {
        return this.wsStatusConsulta.consultaStatus(uf, modelo, tpEmis);
    }
    ...
    /**
     * Retorna XML Assinado afim para o usuário para retornar o envio .
     *
     * @param chaveDeAcesso chave de acesso da nota
     * @param textoCorrecao texto de correcao
     * @param numeroSequencialEvento numero sequencial de evento, esse numero
     ...
     * o sefaz
     */
    public String geraXMLCorrecaoAssinado(final String chaveDeAcesso, final String textoCorrecao, final int numeroSequencialEvento) throws Exception {
     ...
     * o sefaz
     */
    public NFProtocoloEventoCancelamento cancelaNota(final String chave, final String numeroProtocolo, final String motivo) throws Exception {
     ...
     * o sefaz
     */
    public NFProtocoloInutilizacao inutilizaNota(final int anoInutilizacaoNumeracao, final String cnpjEmitente, final String serie, final String numeroInicial, final String numeroFinal, final String justificativa, final DFModelo modelo) throws Exception {
