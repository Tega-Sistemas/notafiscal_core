package br.com.tegasistemas.documentofiscal.nfe400.utils;
...
public class NFGeraQRCode {
    ...
    public String getQRCodev2() throws NoSuchAlgorithmException {
        ...
        System.out.println("*****************************************************************************************");
        System.out.println(this.config.getCodigoSegurancaContribuinteID().toString());
        System.out.println(url.concat("?p=").concat(parametros.toString().concat("|").concat(StringUtils.upperCase(NFGeraQRCode.createHash(parametros.toString(), this.config.getCodigoSegurancaContribuinte())))));
        System.out.println("*****************************************************************************************");
