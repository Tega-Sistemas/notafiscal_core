package br.com.tegasistemas.documentofiscal.nfe400.classes;
...
//        https://www.nfe.fazenda.gov.br/SCEConsultaRFB/SCEConsultaRFB.asmx
    ...
    /* Usam SVC-AN -> AC, AL, AP, DF, ES, MG, PA, PB, RJ, RN, RO, RR, RS, SC, SE, SP, TO */
    SVCAN {
        @Override
        public String getNfeAutorizacao(final DFAmbiente ambiente) {
            return DFAmbiente.HOMOLOGACAO.equals(ambiente) ? null : "https://www.svc.fazenda.gov.br/NFeAutorizacao4/NFeAutorizacao4.asmx";
        }

        @Override
        public String getNfeRetAutorizacao(final DFAmbiente ambiente) {
            return DFAmbiente.HOMOLOGACAO.equals(ambiente) ? null : "https://www.svc.fazenda.gov.br/NFeRetAutorizacao4/NFeRetAutorizacao4.asmx";
        }

        @Override
        public String getNfeConsultaProtocolo(final DFAmbiente ambiente) {
            return DFAmbiente.HOMOLOGACAO.equals(ambiente) ? null : "https://www.svc.fazenda.gov.br/NFeConsultaProtocolo4/NFeConsultaProtocolo4.asmx";
        }

        @Override
        public String getNfeStatusServico(final DFAmbiente ambiente) {
            return DFAmbiente.HOMOLOGACAO.equals(ambiente) ? null : "https://www.svc.fazenda.gov.br/NFeStatusServico4/NFeStatusServico4.asmx";
        }

        @Override
        public String getRecepcaoEvento(final DFAmbiente ambiente) {
            return DFAmbiente.HOMOLOGACAO.equals(ambiente) ? null : "https://www.svc.fazenda.gov.br/NFeRecepcaoEvento4/NFeRecepcaoEvento4.asmx";
        }
        ...
        @Override
        public String getNfeInutilizacao(final DFAmbiente ambiente) {
            return DFAmbiente.HOMOLOGACAO.equals(ambiente) ? null : "https://www.sefazvirtual.fazenda.gov.br/NFeInutilizacao4/NFeInutilizacao4.asmx";
        }
    ...
    /* Usam SVC-RS -> AM, BA, CE, GO, MA, MS, MT, PE, PI, PR */
    SVCRS {
        @Override
        public String getNfeAutorizacao(final DFAmbiente ambiente) {
            return DFAmbiente.HOMOLOGACAO.equals(ambiente) ? "https://hom.sefazvirtual.fazenda.gov.br/NFeAutorizacao4/NFeAutorizacao4.asmx" : "https://www.sefazvirtual.fazenda.gov.br/NFeAutorizacao4/NFeAutorizacao4.asmx";
    ...
    public static NFAutorizador400 valueOfChaveAcesso(final String chaveAcesso) {
        ...
        String FormaEmissao = chaveParser.getFormaEmissao().getCodigo();
        if (FormaEmissao.equals("7")) {
            return NFAutorizador400.SVRS;
        } else if (FormaEmissao.equals("6")) {
