package br.com.tegasistemas.documentofiscal.gnre200.configuf;
...
public class ConfigUFApplication {
    ...
    private static final String HOM_SERVICE_URL = "https://www.testegnre.pe.gov.br/gnreWS/services/GnreConfigUF";
    private static final String HOM_SERVICE_ACTION = "https://www.testegnre.pe.gov.br/gnreWS/services/GnreConfigUF/consultar";
    private static final String PROD_SERVICE_URL = "https://www.gnre.pe.gov.br/gnreWS/services/GnreConfigUF";
    private static final String PROD_SERVICE_ACTION = "https://www.gnre.pe.gov.br/gnreWS/services/GnreConfigUF/consultar";
    private static final String VERSAO = "2.00";
    private static String AMBIENTE = null;
    private static GnreConfig config;
    private String logs;
    ...
    public String ConfigUF(String UF, String receita, String certificado, String keystore, String senhaCertificado, String senhaKeystore, int ambiente) throws Exception {
        ...
        ConfigUfModel model = new ConfigUfModel(AMBIENTE, UF, receita);
