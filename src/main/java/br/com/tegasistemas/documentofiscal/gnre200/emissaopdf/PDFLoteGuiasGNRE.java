package br.com.tegasistemas.documentofiscal.gnre200.emissaopdf;
...
class PDFLoteGuiasGNRE {
    ...
    void addGuiasTo(Document doc, PdfWriter writer) throws DocumentException {
        while (fields.hasNext()) {
            ...
            addVia(doc, writer, "1� via - Banco");

            addSeparadorVia(doc);

            addViaInvalidaWarn(doc);
            addMotivosRejeicao(doc);
            addVia(doc, writer, "2� via - Contribuinte");

            if (fields.is3aViaVisivel()) {
                addViaInvalidaWarn(doc);
                addMotivosRejeicao(doc);
                addVia(doc, writer, "3� via - Contribuinte/Fisco");
            }
        }
    }
    ...
    private void addViaInvalidaWarn(Document doc) throws DocumentException {
        if (!fields.isValida()) {
            doc.add(new Paragraph("Guia Inv�lida para Pagamento", FontFactory.getFont(FontFactory.HELVETICA, 12, Font.BOLD, BaseColor.RED)));
        }
    }
        ...
        fields.getMotivosRejeicao()
                .forEach(mr -> {
                    try {
                        ...
                        throw new RuntimeException("Erro ao adicionar motivo de rejei��o no documento.", ex);
                    }
                });
    }
    ...
    private PdfPCell getAutenticacaoCell() {
        PdfPCell cell = new PdfPCell(new Phrase("Autentica��o", AUTENTICACAO_FONT));
    ...
    private PdfPCell getViaCell21() {
        ...
        // linha 2
        PdfPCell razaoSocialLabel = getLabelCell("Raz�o Social:");
        ...
        // linha 4
        PdfPCell enderecoLabel = getLabelCell("Endere�o:");
    ...
    private PdfPCell getViaCell22() {
        ...
        nossoNumeroCell.addElement(get2LinesField("N� de Controle", fields.getNossoNumero()));
        ...
        numeroDocumentoOrigemCell.addElement(get2LinesField("N� Documento de Origem", fields.getNumeroDocumentoOrigem()));
    ...
    private PdfPTable getDadosDestinatario() {
        ...
        PdfPCell titleCell = getLabelCell("Dados do Destinat�rio");
        titleCell.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
        table.addCell(titleCell);
    ...
    private PdfPTable getReservadoFiscalizacao() {
        ...
        PdfPCell titleCell = getLabelCell("Reservado a Fiscaliza��o");
        titleCell.setHorizontalAlignment(PdfPCell.ALIGN_CENTER);
        table.addCell(titleCell);
        ...
        convenioCell.addElement(get2ColumnsField("Conv�nio/Protocolo:", fields.getConvenio()));
    ...
    private PdfPTable getInformacoesComplementares() {
        ...
        PdfPCell informacaoComplementarLabelCell = getLabelCell("Informa��es Complementares");
        ...
        dataLimitePagamentoCell.addElement(get2ColumnsField("Documento v�lido para pagamento at�:", fields.getDataLimitePagamento()));
    ...
    private PdfPCell getViaCell32() {
        ...
        periodoReferenciaCell.addElement(get2LinesField("Per�odo de Refer�ncia", fields.getPeriodoReferencia()));
        ...
        atuaizacaoMonetariaCell.addElement(get2LinesField("Atualiza��o Monet�ria", fields.getAtualizacaoMonetaria()));
