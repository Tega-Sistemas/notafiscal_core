package br.com.tegasistemas.documentofiscal;
...
public enum DFUnidadeFederativa {
    ...
    PR("PR", "Paran\u00E1", "41", "http://www.fazenda.pr.gov.br/nfce/qrcode", "http://www.fazenda.pr.gov.br/nfce/qrcode", "http://www.fazenda.pr.gov.br", "http://www.fazenda.pr.gov.br", "https://www.testegnre.pe.gov.br/gnreWS/services", "https://www.gnre.pe.gov.br/gnreWS/services"),
    ...
    private final String gnreHomologacao;
    private final String gnreProducao;
    
    DFUnidadeFederativa(final String codigo, final String descricao, final String codigoIbge, String qrCodeHomologacao, String qrCodeProducao, String consultaChaveAcessoHomologacao, String consultaChaveAcessoProducao, String gnreHomologacao, String gnreProducao) {
        this.codigo = codigo;
        ...
        this.gnreHomologacao = gnreHomologacao;
        this.gnreProducao = gnreProducao;
    }
    
    DFUnidadeFederativa(final String codigo, final String descricao, final String codigoIbge, String gnreHomologacao, String gnreProducao) {
    ...
    public String getGnreHomologacao() {
        return gnreHomologacao;
    }

    public String getGnreProducao() {
        return gnreProducao;
    }
