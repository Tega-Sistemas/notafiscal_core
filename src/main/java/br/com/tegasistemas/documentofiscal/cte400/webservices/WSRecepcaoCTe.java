...
import br.com.tegasistemas.documentofiscal.cte400.webservices.gerado.CTeRecepcaoSincV4Stub;
import br.com.tegasistemas.documentofiscal.DFLog;
import br.com.tegasistemas.documentofiscal.cte400.classes.CTAutorizador400;
...
class WSRecepcaoCTe implements DFLog {
    ...
    public String enviaCTeXML(String XML) throws Exception {
        final String documentoAssinado = new DFAssinaturaDigital(this.config).assinarDocumento(XML, "infCte");
        return documentoAssinado + ";" + comunicaLote(documentoAssinado);
    }
