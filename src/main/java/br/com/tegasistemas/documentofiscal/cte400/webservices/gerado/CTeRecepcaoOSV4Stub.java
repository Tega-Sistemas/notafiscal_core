...
public class CTeRecepcaoOSV4Stub extends org.apache.axis2.client.Stub {
     ...
     * @param cteDadosMsg
     */
    public CTeRecepcaoOSV4Stub.CteRecepcaoOSResult cteRecepcaoOS(
        CTeRecepcaoOSV4Stub.CteDadosMsg cteDadosMsg)
        ...
        try {
            ...
            java.lang.Object object = fromOM(_returnEnv.getBody()
                                                       .getFirstElement(),
                    CTeRecepcaoOSV4Stub.CteRecepcaoOSResult.class,
                    getEnvelopeNamespaces(_returnEnv));

            return (CTeRecepcaoOSV4Stub.CteRecepcaoOSResult) object;
    ...
    private org.apache.axiom.om.OMElement toOM(
        CTeRecepcaoOSV4Stub.CteDadosMsg param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(CTeRecepcaoOSV4Stub.CteDadosMsg.MY_QNAME,
    ...
    private org.apache.axiom.om.OMElement toOM(
        CTeRecepcaoOSV4Stub.CteRecepcaoOSResult param,
        boolean optimizeContent) throws org.apache.axis2.AxisFault {
        try {
            return param.getOMElement(CTeRecepcaoOSV4Stub.CteRecepcaoOSResult.MY_QNAME,
                org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        } catch (org.apache.axis2.databinding.ADBException e) {
            throw org.apache.axis2.AxisFault.makeFault(e);
        }
    ...
    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
        ...
        try {
            ...
            emptyEnvelope.getBody()
                    ...
                    CTeRecepcaoOSV4Stub.CteDadosMsg.MY_QNAME,
                    factory));
    ...
    private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
        ...
        throws org.apache.axis2.AxisFault {
        try {
            if (CTeRecepcaoOSV4Stub.CteDadosMsg.class.equals(
                        type)) {
                return CTeRecepcaoOSV4Stub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }

            if (CTeRecepcaoOSV4Stub.CteRecepcaoOSResult.class.equals(
                        type)) {
                return CTeRecepcaoOSV4Stub.CteRecepcaoOSResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
