...
import br.com.tegasistemas.documentofiscal.cte400.classes.envio.CTeOSEnvioRetornoDados;
...
import br.com.tegasistemas.documentofiscal.cte400.classes.evento.comprovanteentrega.CTeEnviaEventoComprovanteEntrega;
import br.com.tegasistemas.documentofiscal.cte400.classes.evento.epec.CTeEnviaEventoEpec;
import br.com.tegasistemas.documentofiscal.cte400.classes.evento.gtv.CTeEnviaEventoGtv;
import br.com.tegasistemas.documentofiscal.cte400.classes.evento.insucessoentrega.CTeEnviaEventoInsucessoEntrega;
...
import br.com.tegasistemas.documentofiscal.cte.classes.distribuicao.CTDistribuicaoIntRetorno;
import br.com.tegasistemas.documentofiscal.cte.webservices.distribuicao.WSDistribuicaoCTe;
...
public class WSFacade {
    ...
    public String enviaCTeXML(String XML) throws Exception {
        return this.wsRecepcaoCTe.enviaCTeXML(XML);
    }
     ...
     * @throws Exception caso nao consiga gerar o xml ou problema de conexao com o sefaz
     */
    public String cancelaNota(final String chave, final String numeroProtocolo, final String motivo) throws Exception {
     ...
     * @throws Exception caso nao consiga gerar o xml ou problema de conexao com o sefaz
     */
    public CTeEventoRetorno corrigeNota(final String chave, String grupoAlterado, String campoAlterado, String valorAlterado, String numeroItemAlterado, int sequencialEvento) throws Exception {
     ...
     * @throws Exception caso nao consiga gerar o xml ou problema de conexao com o sefaz
     */
    public String corrigeNotaXML(final String chave, String grupoAlterado, String campoAlterado, String valorAlterado, String numeroItemAlterado, int sequencialEvento) throws Exception {
        return this.wsCartaCorrecao.corrigeNotaXML(chave, grupoAlterado, campoAlterado, valorAlterado, numeroItemAlterado, sequencialEvento);
    }
