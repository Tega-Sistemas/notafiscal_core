...
import br.com.tegasistemas.documentofiscal.cte400.classes.envio.CTeProtocolo;
...
public class CTeProcessado extends DFBase {
    ...
    @Element(name = "CTeReplace", required = false)
    private String cteReplace;
    ...
    public void setCteReplace(final String cteReplace) {
        this.cteReplace = cteReplace;
    }
}
