package br.com.tegasistemas.documentofiscal.cte300.webservices.statusservico;
...
public class CteStatusServicoStub extends org.apache.axis2.client.Stub {
    ...
    public CteStatusServicoStub.CteStatusServicoCTResult cteStatusServicoCT(final CteStatusServicoStub.CteDadosMsg cteDadosMsg0, final CteStatusServicoStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), CteStatusServicoStub.CteStatusServicoCTResult.class, this.getEnvelopeNamespaces(_returnEnv));
     ...
     * @param cteCabecMsg1
     */
    public void startcteStatusServicoCT(final CteStatusServicoStub.CteDadosMsg cteDadosMsg0, final CteStatusServicoStub.CteCabecMsgE cteCabecMsg1, final CteStatusServicoCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteStatusServico/cteStatusServicoCT");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = CteStatusServicoStub.this.fromOM(resultEnv.getBody().getFirstElement(), CteStatusServicoStub.CteStatusServicoCTResult.class, CteStatusServicoStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultcteStatusServicoCT((CteStatusServicoStub.CteStatusServicoCTResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final CteStatusServicoStub.CteDadosMsg param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(CteStatusServicoStub.CteDadosMsg.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final CteStatusServicoStub.CteStatusServicoCTResult param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(CteStatusServicoStub.CteStatusServicoCTResult.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final CteStatusServicoStub.CteCabecMsgE param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(CteStatusServicoStub.CteCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final CteStatusServicoStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        //        try {
