package br.com.tegasistemas.documentofiscal.cte300.webservices.recepcao;
...
public class CteRecepcaoStub extends org.apache.axis2.client.Stub {
    ...
    public CteRecepcaoStub.CteRecepcaoLoteResult cteRecepcaoLote(final CteRecepcaoStub.CteDadosMsg cteDadosMsg0, final CteRecepcaoStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), CteRecepcaoStub.CteRecepcaoLoteResult.class, this.getEnvelopeNamespaces(_returnEnv));
     ...
     * @param cteCabecMsg1
     */
    public void startcteRecepcaoLote(final CteRecepcaoStub.CteDadosMsg cteDadosMsg0, final CteRecepcaoStub.CteCabecMsgE cteCabecMsg1, final CteRecepcaoCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcao/cteRecepcaoLote");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = CteRecepcaoStub.this.fromOM(resultEnv.getBody().getFirstElement(), CteRecepcaoStub.CteRecepcaoLoteResult.class, CteRecepcaoStub.this.getEnvelopeNamespaces(resultEnv));
    ...
    private org.apache.axiom.om.OMElement toOM(final CteRecepcaoStub.CteDadosMsg param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(CteRecepcaoStub.CteDadosMsg.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final CteRecepcaoStub.CteRecepcaoLoteResult param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(CteRecepcaoStub.CteRecepcaoLoteResult.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final CteRecepcaoStub.CteCabecMsgE param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(CteRecepcaoStub.CteCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final CteRecepcaoStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        //try {
