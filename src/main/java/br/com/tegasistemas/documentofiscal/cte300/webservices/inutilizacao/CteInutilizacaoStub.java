package br.com.tegasistemas.documentofiscal.cte300.webservices.inutilizacao;
...
public class CteInutilizacaoStub extends org.apache.axis2.client.Stub {
     ...
     * @param config
     */
    public CteInutilizacaoStub(String urlWebService, CTeConfig config) throws org.apache.axis2.AxisFault {
        this(urlWebService);
    }
    ...
    public CteInutilizacaoStub.CteInutilizacaoCTResult cteInutilizacaoCT(final CteInutilizacaoStub.CteDadosMsg cteDadosMsg0, final CteInutilizacaoStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), CteInutilizacaoStub.CteInutilizacaoCTResult.class, this.getEnvelopeNamespaces(_returnEnv));
     ...
     * @param cteCabecMsg1
     */
    public void startcteInutilizacaoCT(final CteInutilizacaoStub.CteDadosMsg cteDadosMsg0, final CteInutilizacaoStub.CteCabecMsgE cteCabecMsg1, final CteInutilizacaoCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteInutilizacao/cteInutilizacaoCT");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = CteInutilizacaoStub.this.fromOM(resultEnv.getBody().getFirstElement(), CteInutilizacaoStub.CteInutilizacaoCTResult.class, CteInutilizacaoStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultcteInutilizacaoCT((CteInutilizacaoStub.CteInutilizacaoCTResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final CteInutilizacaoStub.CteDadosMsg param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(CteInutilizacaoStub.CteDadosMsg.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final CteInutilizacaoStub.CteInutilizacaoCTResult param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(CteInutilizacaoStub.CteInutilizacaoCTResult.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final CteInutilizacaoStub.CteCabecMsgE param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(CteInutilizacaoStub.CteCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final CteInutilizacaoStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        //        try {
