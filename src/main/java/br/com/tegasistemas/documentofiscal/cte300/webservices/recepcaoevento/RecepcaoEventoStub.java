package br.com.tegasistemas.documentofiscal.cte300.webservices.recepcaoevento;
...
public class RecepcaoEventoStub extends org.apache.axis2.client.Stub {
    ...
    public RecepcaoEventoStub.CteRecepcaoEventoResult cteRecepcaoEvento(final RecepcaoEventoStub.CteDadosMsg cteDadosMsg0, final RecepcaoEventoStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), RecepcaoEventoStub.CteRecepcaoEventoResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (RecepcaoEventoStub.CteRecepcaoEventoResult) object;
     ...
     * @param cteCabecMsg1
     */
    public void startcteRecepcaoEvento(final RecepcaoEventoStub.CteDadosMsg cteDadosMsg0, final RecepcaoEventoStub.CteCabecMsgE cteCabecMsg1, final RecepcaoEventoCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoEvento/cteRecepcaoEvento");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = RecepcaoEventoStub.this.fromOM(resultEnv.getBody().getFirstElement(), RecepcaoEventoStub.CteRecepcaoEventoResult.class, RecepcaoEventoStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultcteRecepcaoEvento((RecepcaoEventoStub.CteRecepcaoEventoResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final RecepcaoEventoStub.CteDadosMsg param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(RecepcaoEventoStub.CteDadosMsg.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final RecepcaoEventoStub.CteRecepcaoEventoResult param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(RecepcaoEventoStub.CteRecepcaoEventoResult.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final RecepcaoEventoStub.CteCabecMsgE param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(RecepcaoEventoStub.CteCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final RecepcaoEventoStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        //        try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        emptyEnvelope.getBody().addChild(param.getOMElement(RecepcaoEventoStub.CteDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (RecepcaoEventoStub.CteDadosMsg.class.equals(type)) {
                return RecepcaoEventoStub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (RecepcaoEventoStub.CteRecepcaoEventoResult.class.equals(type)) {
                return RecepcaoEventoStub.CteRecepcaoEventoResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (RecepcaoEventoStub.CteCabecMsgE.class.equals(type)) {
                return RecepcaoEventoStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
