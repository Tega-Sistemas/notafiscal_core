package br.com.tegasistemas.documentofiscal.cte300.classes;
...
public enum CTAutorizador31 {
    ...
    PR {
        ...
        @Override
        public String getCteInutilizacao(final DFAmbiente ambiente) {
            return DFAmbiente.HOMOLOGACAO.equals(ambiente) ? "https://homologacao.cte.fazenda.pr.gov.br/cte/CteInutilizacao" : "https://cte.fazenda.pr.gov.br/cte/CteInutilizacao";
        }
    ...
    SVSP {
        @Override
        public String getCteRecepcao(final DFAmbiente ambiente) {
            return DFAmbiente.HOMOLOGACAO.equals(ambiente) ? "https://nfe.fazenda.sp.gov.br/cteWEB/services/cteRecepcao.asmx" : "https://nfe.fazenda.sp.gov.br/cteWEB/services/cteRecepcao.asmx";
        }
    ...
    public static CTAutorizador31 valueOfTipoEmissao(final String tpEmissao, final DFUnidadeFederativa uf) {
        switch (tpEmissao) {
            case "1":
            ...
            case "7":
                return CTAutorizador31.SVRS;
            default:
                throw new IllegalArgumentException("Não ha implementacão para o tipo de emissão: " + tpEmissao);
        }
    }
}