...
import br.com.tegasistemas.documentofiscal.cte300.webservices.retrecepcao.CteRetRecepcaoStub;
import br.com.tegasistemas.documentofiscal.DFLog;
import br.com.tegasistemas.documentofiscal.cte300.classes.enviolote.consulta.CTeConsultaRecLote;
...
class WSRecepcaoLoteRetorno implements DFLog {
    ...
    CTeConsultaRecLoteRet consultaLote(final String numeroRecibo) throws Exception {
        ...
        System.out.println("------XML "+omElementConsulta);
    ...
    private OMElement efetuaConsulta(final OMElement omElement) throws RemoteException {
        ...
        final CteRetRecepcaoStub.CteRetRecepcaoResult autorizacaoLoteResult = new CteRetRecepcaoStub(endpoint).cteRetRecepcao(dados, cabecE);
