package br.com.tegasistemas.documentofiscal.cte300.webservices.retrecepcao;
...
public class CteRetRecepcaoStub extends org.apache.axis2.client.Stub {
    ...
    public CteRetRecepcaoStub.CteRetRecepcaoResult cteRetRecepcao(final CteRetRecepcaoStub.CteDadosMsg cteDadosMsg0, final CteRetRecepcaoStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), CteRetRecepcaoStub.CteRetRecepcaoResult.class, this.getEnvelopeNamespaces(_returnEnv));
     ...
     * @param cteCabecMsg1
     */
    public void startcteRetRecepcao(final CteRetRecepcaoStub.CteDadosMsg cteDadosMsg0, final CteRetRecepcaoStub.CteCabecMsgE cteCabecMsg1, final CteRetRecepcaoCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteRetRecepcao/cteRetRecepcao");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = CteRetRecepcaoStub.this.fromOM(resultEnv.getBody().getFirstElement(), CteRetRecepcaoStub.CteRetRecepcaoResult.class, CteRetRecepcaoStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultcteRetRecepcao((CteRetRecepcaoStub.CteRetRecepcaoResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final CteRetRecepcaoStub.CteDadosMsg param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(CteRetRecepcaoStub.CteDadosMsg.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final CteRetRecepcaoStub.CteRetRecepcaoResult param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(CteRetRecepcaoStub.CteRetRecepcaoResult.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final CteRetRecepcaoStub.CteCabecMsgE param, final boolean optimizeContent) {
        //        try {
        return param.getOMElement(CteRetRecepcaoStub.CteCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final CteRetRecepcaoStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        //        try {
