...
public class CTeProtocoloEventoCartaCorrecao extends DFBase {
    ...
    private CTeEventoCartaCorrecao evento;
    ...
    public CTeEventoCartaCorrecao getEvento() {
        return this.evento;
    }

    public void setEvento(final CTeEventoCartaCorrecao evento) {
        this.evento = evento;
    }
