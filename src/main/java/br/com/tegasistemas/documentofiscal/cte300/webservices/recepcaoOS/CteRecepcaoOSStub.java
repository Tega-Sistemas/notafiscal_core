package br.com.tegasistemas.documentofiscal.cte300.webservices.recepcaoOS;
...
public class CteRecepcaoOSStub extends org.apache.axis2.client.Stub {
    ...
    public CteRecepcaoOSStub.CteRecepcaoOSResult cteRecepcaoOS(final CteRecepcaoOSStub.CteDadosMsg cteDadosMsg0, final CteRecepcaoOSStub.CteCabecMsgE cteCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), CteRecepcaoOSStub.CteRecepcaoOSResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (CteRecepcaoOSStub.CteRecepcaoOSResult) object;
     ...
     * @param cteCabecMsg1
     */
    public void startcteRecepcaoOS(final CteRecepcaoOSStub.CteDadosMsg cteDadosMsg0, final CteRecepcaoOSStub.CteCabecMsgE cteCabecMsg1, final CteRecepcaoOSCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/cte/wsdl/CteRecepcaoOS/cteRecepcaoOS");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = CteRecepcaoOSStub.this.fromOM(resultEnv.getBody().getFirstElement(), CteRecepcaoOSStub.CteRecepcaoOSResult.class, CteRecepcaoOSStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultcteRecepcaoOS((CteRecepcaoOSStub.CteRecepcaoOSResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final CteRecepcaoOSStub.CteDadosMsg param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(CteRecepcaoOSStub.CteDadosMsg.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final CteRecepcaoOSStub.CteRecepcaoOSResult param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(CteRecepcaoOSStub.CteRecepcaoOSResult.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.om.OMElement toOM(final CteRecepcaoOSStub.CteCabecMsgE param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(CteRecepcaoOSStub.CteCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //        } catch (final org.apache.axis2.databinding.ADBException e) {
        //            throw org.apache.axis2.AxisFault.makeFault(e);
        //        }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final CteRecepcaoOSStub.CteDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        //try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        emptyEnvelope.getBody().addChild(param.getOMElement(CteRecepcaoOSStub.CteDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (CteRecepcaoOSStub.CteDadosMsg.class.equals(type)) {
                return CteRecepcaoOSStub.CteDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (CteRecepcaoOSStub.CteRecepcaoOSResult.class.equals(type)) {
                return CteRecepcaoOSStub.CteRecepcaoOSResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (CteRecepcaoOSStub.CteCabecMsgE.class.equals(type)) {
                return CteRecepcaoOSStub.CteCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
