 ...
 */
package br.com.tegasistemas.documentofiscal.mdfe3.webservices.statusservico;
...
public class MDFeStatusServicoStub extends org.apache.axis2.client.Stub {
    ...
    public MDFeStatusServicoStub.MdfeStatusServicoMDFResult mdfeStatusServicoMDF(final MDFeStatusServicoStub.MdfeDadosMsg mdfeDadosMsg0, final MDFeStatusServicoStub.MdfeCabecMsgE mdfeCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), MDFeStatusServicoStub.MdfeStatusServicoMDFResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (MDFeStatusServicoStub.MdfeStatusServicoMDFResult) object;
     ...
     * @param mdfeCabecMsg1
     */
    public void startmdfeStatusServicoMDF(final MDFeStatusServicoStub.MdfeDadosMsg mdfeDadosMsg0, final MDFeStatusServicoStub.MdfeCabecMsgE mdfeCabecMsg1, final MDFeStatusServicoCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeStatusServico/mdfeStatusServicoMDF");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = MDFeStatusServicoStub.this.fromOM(resultEnv.getBody().getFirstElement(), MDFeStatusServicoStub.MdfeStatusServicoMDFResult.class, MDFeStatusServicoStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultmdfeStatusServicoMDF((MDFeStatusServicoStub.MdfeStatusServicoMDFResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final MDFeStatusServicoStub.MdfeCabecMsgE param, final boolean optimizeContent) {
        //try {
        return param.getOMElement(MDFeStatusServicoStub.MdfeCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        //} catch (final org.apache.axis2.databinding.ADBException e) {
        //    throw org.apache.axis2.AxisFault.makeFault(e);
        //}
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final MDFeStatusServicoStub.MdfeDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        //        try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        emptyEnvelope.getBody().addChild(param.getOMElement(MDFeStatusServicoStub.MdfeDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (MDFeStatusServicoStub.MdfeDadosMsg.class.equals(type)) {
                return MDFeStatusServicoStub.MdfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (MDFeStatusServicoStub.MdfeStatusServicoMDFResult.class.equals(type)) {
                return MDFeStatusServicoStub.MdfeStatusServicoMDFResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (MDFeStatusServicoStub.MdfeCabecMsgE.class.equals(type)) {
                return MDFeStatusServicoStub.MdfeCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
