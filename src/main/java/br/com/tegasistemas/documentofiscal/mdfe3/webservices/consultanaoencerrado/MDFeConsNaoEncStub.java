 ...
 */
package br.com.tegasistemas.documentofiscal.mdfe3.webservices.consultanaoencerrado;
...
public class MDFeConsNaoEncStub extends org.apache.axis2.client.Stub {
    ...
    public MDFeConsNaoEncStub.MdfeConsNaoEncResult mdfeConsNaoEnc(final MDFeConsNaoEncStub.MdfeDadosMsg mdfeDadosMsg0, final MDFeConsNaoEncStub.MdfeCabecMsgE mdfeCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), MDFeConsNaoEncStub.MdfeConsNaoEncResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (MDFeConsNaoEncStub.MdfeConsNaoEncResult) object;
     ...
     * @param mdfeCabecMsg1
     */
    public void startmdfeConsNaoEnc(final MDFeConsNaoEncStub.MdfeDadosMsg mdfeDadosMsg0, final MDFeConsNaoEncStub.MdfeCabecMsgE mdfeCabecMsg1, final MDFeConsNaoEncCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsNaoEnc/mdfeConsNaoEnc");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = MDFeConsNaoEncStub.this.fromOM(resultEnv.getBody().getFirstElement(), MDFeConsNaoEncStub.MdfeConsNaoEncResult.class, MDFeConsNaoEncStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultmdfeConsNaoEnc((MDFeConsNaoEncStub.MdfeConsNaoEncResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final MDFeConsNaoEncStub.MdfeCabecMsgE param, final boolean optimizeContent) {
        // try {
        return param.getOMElement(MDFeConsNaoEncStub.MdfeCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        // } catch (org.apache.axis2.databinding.ADBException e) {
        // throw org.apache.axis2.AxisFault.makeFault(e);
        // }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final MDFeConsNaoEncStub.MdfeDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        // try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        emptyEnvelope.getBody().addChild(param.getOMElement(MDFeConsNaoEncStub.MdfeDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (MDFeConsNaoEncStub.MdfeDadosMsg.class.equals(type)) {
                return MDFeConsNaoEncStub.MdfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (MDFeConsNaoEncStub.MdfeConsNaoEncResult.class.equals(type)) {
                return MDFeConsNaoEncStub.MdfeConsNaoEncResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (MDFeConsNaoEncStub.MdfeCabecMsgE.class.equals(type)) {
                return MDFeConsNaoEncStub.MdfeCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
