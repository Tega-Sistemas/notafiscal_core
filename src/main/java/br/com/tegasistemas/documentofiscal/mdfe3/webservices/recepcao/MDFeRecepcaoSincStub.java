package br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao;
...
public class MDFeRecepcaoSincStub extends org.apache.axis2.client.Stub {
    ...
    public br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult mdfeRecepcaoSinc(final br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg mdfeDadosMsg0) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult) object;
     ...
     * @param mdfeCabecMsg1
     */
    public void startmdfeRecepcao(final br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg mdfeDadosMsg0, final br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
...
//        this._serviceClient.addHeadersToEnvelope(env);
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = MDFeRecepcaoSincStub.this.fromOM(resultEnv.getBody().getFirstElement(), br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult.class, MDFeRecepcaoSincStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultmdfeRecepcaoSinc((br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult) object);
    ...
    // private org.apache.axiom.om.OMElement toOM(br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoStub.MdfeDadosMsg param, boolean optimizeContent) throws org.apache.axis2.AxisFault {
    // try {
    // return param.getOMElement(br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoStub.MdfeDadosMsg.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
    // } catch (org.apache.axis2.databinding.ADBException e) {
    // throw org.apache.axis2.AxisFault.makeFault(e);
    // }
    // }
    //
    // private org.apache.axiom.om.OMElement toOM(br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoStub.MdfeRecepcaoLoteResult param, boolean optimizeContent) throws org.apache.axis2.AxisFault {
    // try {
    // return param.getOMElement(br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoStub.MdfeRecepcaoLoteResult.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
    // } catch (org.apache.axis2.databinding.ADBException e) {
    // throw org.apache.axis2.AxisFault.makeFault(e);
    // }
    // }

    private org.apache.axiom.om.OMElement toOM(final br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeCabecMsgE param, final boolean optimizeContent) {
        // try {
        return param.getOMElement(br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        // } catch (org.apache.axis2.databinding.ADBException e) {
        // throw org.apache.axis2.AxisFault.makeFault(e);
        // }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        // try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        // remove o header
        emptyEnvelope.getHeader().discard();
        emptyEnvelope.getBody().addChild(param.getOMElement(br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg.class.equals(type)) {
                return br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult.class.equals(type)) {
                return br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeRecepcaoSincResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeCabecMsgE.class.equals(type)) {
                return br.com.tegasistemas.documentofiscal.mdfe3.webservices.recepcao.MDFeRecepcaoSincStub.MdfeCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
