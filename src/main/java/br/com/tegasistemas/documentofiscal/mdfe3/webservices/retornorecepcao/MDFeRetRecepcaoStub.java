 ...
 */
package br.com.tegasistemas.documentofiscal.mdfe3.webservices.retornorecepcao;
...
public class MDFeRetRecepcaoStub extends org.apache.axis2.client.Stub {
    ...
    public MDFeRetRecepcaoStub.MdfeRetRecepcaoResult mdfeRetRecepcao(final MDFeRetRecepcaoStub.MdfeDadosMsg mdfeDadosMsg0, final MDFeRetRecepcaoStub.MdfeCabecMsgE mdfeCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), MDFeRetRecepcaoStub.MdfeRetRecepcaoResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (MDFeRetRecepcaoStub.MdfeRetRecepcaoResult) object;
     ...
     * @param mdfeCabecMsg1
     */
    public void startmdfeRetRecepcao(final MDFeRetRecepcaoStub.MdfeDadosMsg mdfeDadosMsg0, final MDFeRetRecepcaoStub.MdfeCabecMsgE mdfeCabecMsg1, final MDFeRetRecepcaoCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRetRecepcao/mdfeRetRecepcao");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = MDFeRetRecepcaoStub.this.fromOM(resultEnv.getBody().getFirstElement(), MDFeRetRecepcaoStub.MdfeRetRecepcaoResult.class, MDFeRetRecepcaoStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultmdfeRetRecepcao((MDFeRetRecepcaoStub.MdfeRetRecepcaoResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final MDFeRetRecepcaoStub.MdfeCabecMsgE param, final boolean optimizeContent) {
        // try {
        return param.getOMElement(MDFeRetRecepcaoStub.MdfeCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        // } catch (org.apache.axis2.databinding.ADBException e) {
        // throw org.apache.axis2.AxisFault.makeFault(e);
        // }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final MDFeRetRecepcaoStub.MdfeDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        // try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        emptyEnvelope.getBody().addChild(param.getOMElement(MDFeRetRecepcaoStub.MdfeDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (MDFeRetRecepcaoStub.MdfeDadosMsg.class.equals(type)) {
                return MDFeRetRecepcaoStub.MdfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (MDFeRetRecepcaoStub.MdfeRetRecepcaoResult.class.equals(type)) {
                return MDFeRetRecepcaoStub.MdfeRetRecepcaoResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (MDFeRetRecepcaoStub.MdfeCabecMsgE.class.equals(type)) {
                return MDFeRetRecepcaoStub.MdfeCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
