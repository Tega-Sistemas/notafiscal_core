...
//      this.wsRecepcaoLoteRetorno = new WSRecepcaoLoteRetorno(config);
     ...
     * @throws Exception
     */
    public MDFeRetorno incluirCondutor(final String chaveAcesso, final String nomeCondutor, final String cpfCondutor, String sequencialEvento) throws Exception {
