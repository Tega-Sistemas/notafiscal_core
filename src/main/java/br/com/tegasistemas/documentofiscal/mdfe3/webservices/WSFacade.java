...
import br.com.tegasistemas.documentofiscal.mdfe3.classes.consultastatusservico.MDFeConsStatServRet;
...
import br.com.tegasistemas.documentofiscal.mdfe3.classes.nota.MDFInfoModalRodoviarioInfPag;
import br.com.tegasistemas.documentofiscal.mdfe3.classes.nota.MDFInfoModalRodoviarioInfViagens;
...
import br.com.tegasistemas.documentofiscal.mdfe3.classes.nota.evento.MDFeEnviaEventoIncluirDFeInfDoc;
...
//        this.wsRecepcaoLoteRetorno = new WSRecepcaoLoteRetorno(config);
     ...
     *                   o sefaz
     */
    public String consultaRecibo(final String numeroRecibo) throws Exception {
     ...
     * @throws Exception
     */
    public MDFeRetorno incluirCondutor(final String chaveAcesso, final String nomeCondutor, final String cpfCondutor, final String sequencialEvento) throws Exception {
        return this.wsIncluirCondutor.incluirCondutor(chaveAcesso, nomeCondutor, cpfCondutor, sequencialEvento);
    }
