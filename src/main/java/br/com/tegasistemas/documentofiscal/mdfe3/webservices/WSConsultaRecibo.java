...
import br.com.tegasistemas.documentofiscal.mdfe3.webservices.retornorecepcao.MDFeRetRecepcaoStub;
...
import br.com.tegasistemas.documentofiscal.mdfe3.classes.consultaRecibo.MDFeConsultaRecibo;
...
class WSConsultaRecibo implements DFLog {
    ...
    String consultaRecibo(final String numeroRecibo) throws Exception {
