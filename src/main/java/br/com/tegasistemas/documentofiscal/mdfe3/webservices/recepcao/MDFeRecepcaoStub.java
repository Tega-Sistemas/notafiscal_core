...
public class MDFeRecepcaoStub extends org.apache.axis2.client.Stub {
    ...
    public MDFeRecepcaoStub.MdfeRecepcaoLoteResult mdfeRecepcaoLote(final MDFeRecepcaoStub.MdfeDadosMsg mdfeDadosMsg0, final MDFeRecepcaoStub.MdfeCabecMsgE mdfeCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), MDFeRecepcaoStub.MdfeRecepcaoLoteResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (MDFeRecepcaoStub.MdfeRecepcaoLoteResult) object;
     ...
     * @param mdfeCabecMsg1
     */
    public void startmdfeRecepcaoLote(final MDFeRecepcaoStub.MdfeDadosMsg mdfeDadosMsg0, final MDFeRecepcaoStub.MdfeCabecMsgE mdfeCabecMsg1, final MDFeRecepcaoCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeRecepcao/mdfeRecepcaoLote");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = MDFeRecepcaoStub.this.fromOM(resultEnv.getBody().getFirstElement(), MDFeRecepcaoStub.MdfeRecepcaoLoteResult.class, MDFeRecepcaoStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultmdfeRecepcaoLote((MDFeRecepcaoStub.MdfeRecepcaoLoteResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final MDFeRecepcaoStub.MdfeCabecMsgE param, final boolean optimizeContent) {
        // try {
        return param.getOMElement(MDFeRecepcaoStub.MdfeCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        // } catch (org.apache.axis2.databinding.ADBException e) {
        // throw org.apache.axis2.AxisFault.makeFault(e);
        // }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final MDFeRecepcaoStub.MdfeDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        // try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        emptyEnvelope.getBody().addChild(param.getOMElement(MDFeRecepcaoStub.MdfeDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (MDFeRecepcaoStub.MdfeDadosMsg.class.equals(type)) {
                return MDFeRecepcaoStub.MdfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (MDFeRecepcaoStub.MdfeRecepcaoLoteResult.class.equals(type)) {
                return MDFeRecepcaoStub.MdfeRecepcaoLoteResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (MDFeRecepcaoStub.MdfeCabecMsgE.class.equals(type)) {
                return MDFeRecepcaoStub.MdfeCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
