 ...
 */
package br.com.tegasistemas.documentofiscal.mdfe3.webservices.consulta;
...
public class MDFeConsultaStub extends org.apache.axis2.client.Stub {
    ...
    public MDFeConsultaStub.MdfeConsultaMDFResult mdfeConsultaMDF(final MDFeConsultaStub.MdfeDadosMsg mdfeDadosMsg0, final MDFeConsultaStub.MdfeCabecMsgE mdfeCabecMsg1) throws java.rmi.RemoteException {
        ...
        try {
            ...
            env = this.toEnvelope(
                    ...
                    mdfeDadosMsg0,
                    this.optimizeContent(new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsulta", "mdfeConsultaMDF")),
                    new javax.xml.namespace.QName("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsulta", "mdfeConsultaMDF")
            );
            env.build();
            ...
            final java.lang.Object object = this.fromOM(_returnEnv.getBody().getFirstElement(), MDFeConsultaStub.MdfeConsultaMDFResult.class, this.getEnvelopeNamespaces(_returnEnv));
            return (MDFeConsultaStub.MdfeConsultaMDFResult) object;
     ...
     * @param mdfeCabecMsg1
     */
    public void startmdfeConsultaMDF(final MDFeConsultaStub.MdfeDadosMsg mdfeDadosMsg0, final MDFeConsultaStub.MdfeCabecMsgE mdfeCabecMsg1, final MDFeConsultaCallbackHandler callback) throws java.rmi.RemoteException {
        final org.apache.axis2.client.OperationClient _operationClient = this._serviceClient.createClient(this._operations[0].getName());
        _operationClient.getOptions().setAction("http://www.portalfiscal.inf.br/mdfe/wsdl/MDFeConsulta/mdfeConsultaMDF");
        _operationClient.getOptions().setExceptionToBeThrownOnSOAPFault(true);
        this.addPropertyToOperationClient(_operationClient, org.apache.axis2.description.WSDL2Constants.ATTR_WHTTP_QUERY_PARAMETER_SEPARATOR, "&");
        ...
        _operationClient.setCallback(new org.apache.axis2.client.async.AxisCallback() {
            ...
            public void onMessage(final org.apache.axis2.context.MessageContext resultContext) {
                try {
                    ...
                    final java.lang.Object object = MDFeConsultaStub.this.fromOM(resultEnv.getBody().getFirstElement(), MDFeConsultaStub.MdfeConsultaMDFResult.class, MDFeConsultaStub.this.getEnvelopeNamespaces(resultEnv));
                    callback.receiveResultmdfeConsultaMDF((MDFeConsultaStub.MdfeConsultaMDFResult) object);
    ...
    private org.apache.axiom.om.OMElement toOM(final MDFeConsultaStub.MdfeCabecMsgE param, final boolean optimizeContent) {
        // try {
        return param.getOMElement(MDFeConsultaStub.MdfeCabecMsgE.MY_QNAME, org.apache.axiom.om.OMAbstractFactory.getOMFactory());
        // } catch (org.apache.axis2.databinding.ADBException e) {
        // throw org.apache.axis2.AxisFault.makeFault(e);
        // }
    }

    private org.apache.axiom.soap.SOAPEnvelope toEnvelope(final org.apache.axiom.soap.SOAPFactory factory, final MDFeConsultaStub.MdfeDadosMsg param, final boolean optimizeContent, final javax.xml.namespace.QName methodQName) {
        // try {
        final org.apache.axiom.soap.SOAPEnvelope emptyEnvelope = factory.getDefaultEnvelope();
        emptyEnvelope.getBody().addChild(param.getOMElement(MDFeConsultaStub.MdfeDadosMsg.MY_QNAME, factory));
    ...
    private java.lang.Object fromOM(final org.apache.axiom.om.OMElement param, final java.lang.Class type, final java.util.Map extraNamespaces) throws org.apache.axis2.AxisFault {
        try {
            if (MDFeConsultaStub.MdfeDadosMsg.class.equals(type)) {
                return MDFeConsultaStub.MdfeDadosMsg.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (MDFeConsultaStub.MdfeConsultaMDFResult.class.equals(type)) {
                return MDFeConsultaStub.MdfeConsultaMDFResult.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
            if (MDFeConsultaStub.MdfeCabecMsgE.class.equals(type)) {
                return MDFeConsultaStub.MdfeCabecMsgE.Factory.parse(param.getXMLStreamReaderWithoutCaching());
            }
