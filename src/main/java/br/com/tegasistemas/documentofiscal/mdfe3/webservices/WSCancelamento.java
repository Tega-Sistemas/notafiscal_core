...
import br.com.tegasistemas.documentofiscal.mdfe3.classes.nota.evento.MDFeDetalhamentoEvento;
import br.com.tegasistemas.documentofiscal.mdfe3.classes.nota.evento.MDFeEvento;
import br.com.tegasistemas.documentofiscal.mdfe3.classes.nota.evento.MDFeInfoEvento;
...
class WSCancelamento implements DFLog {
    ...
    private OMElement efetuaCancelamento(final String xmlAssinado, final String chaveAcesso) throws Exception {
        ...
        MDFeRecepcaoEventoStub.MdfeRecepcaoEventoResult mdfeRecepcaoEventoResult = new MDFeRecepcaoEventoStub(urlWebService, this.config).mdfeRecepcaoEvento(dados, cabecE);
