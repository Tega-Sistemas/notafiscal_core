...
import br.com.tegasistemas.documentofiscal.nfe310.classes.lote.consulta.NFLoteConsulta;
import br.com.tegasistemas.documentofiscal.nfe310.classes.lote.consulta.NFLoteConsultaRetorno;
import br.com.tegasistemas.documentofiscal.nfe310.webservices.gerado.NfeRetAutorizacaoStub;
...
class WSLoteConsulta implements DFLog {
    ...
    private OMElement efetuaConsulta(final OMElement omElement, final DFModelo modelo) throws RemoteException {
        ...
        final NfeRetAutorizacaoStub.NfeRetAutorizacaoLoteResult autorizacaoLoteResult = new NfeRetAutorizacaoStub(urlWebService).nfeRetAutorizacaoLote(dados, cabecE);
