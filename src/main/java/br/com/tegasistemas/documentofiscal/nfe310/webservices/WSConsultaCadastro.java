...
import br.com.tegasistemas.documentofiscal.nfe310.classes.cadastro.NFConsultaCadastro;
import br.com.tegasistemas.documentofiscal.nfe310.classes.cadastro.NFInfoConsultaCadastro;
...
class WSConsultaCadastro implements DFLog {
    ...
    private OMElement efetuaConsulta(final DFUnidadeFederativa uf, final OMElement omElementConsulta) throws RemoteException {
        final CadConsultaCadastro2Stub.NfeCabecMsg cabec = new CadConsultaCadastro2Stub.NfeCabecMsg();
        cabec.setCUF(uf.getCodigoIbge());
        cabec.setVersaoDados(WSConsultaCadastro.VERSAO_SERVICO);
        
        final CadConsultaCadastro2Stub.NfeCabecMsgE cabecE = new CadConsultaCadastro2Stub.NfeCabecMsgE();
