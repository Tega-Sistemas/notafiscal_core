...
import br.com.tegasistemas.documentofiscal.nfe310.classes.lote.envio.NFLoteEnvio;
import br.com.tegasistemas.documentofiscal.nfe310.classes.lote.envio.NFLoteEnvioRetorno;
import br.com.tegasistemas.documentofiscal.nfe310.classes.lote.envio.NFLoteEnvioRetornoDados;
import br.com.tegasistemas.documentofiscal.nfe310.classes.nota.NFNota;
import br.com.tegasistemas.documentofiscal.nfe310.classes.nota.NFNotaInfoSuplementar;
import br.com.tegasistemas.documentofiscal.nfe310.utils.NFGeraChave;
import br.com.tegasistemas.documentofiscal.nfe310.utils.NFGeraQRCode;
import br.com.tegasistemas.documentofiscal.nfe310.webservices.gerado.NfeAutorizacaoStub;
...
class WSLoteEnvio implements DFLog {
    ...
    private NFLoteEnvioRetorno comunicaLote(final String loteAssinadoXml, final DFModelo modelo) throws Exception {
        ...
        final NfeAutorizacaoStub.NfeDadosMsg dados = new NfeAutorizacaoStub.NfeDadosMsg();
        dados.setExtraElement(omElement);
        
        final NfeAutorizacaoStub.NfeCabecMsgE cabecalhoSOAP = this.getCabecalhoSOAP();
        ...
        final NfeAutorizacaoStub.NfeAutorizacaoLoteResult autorizacaoLoteResult = new NfeAutorizacaoStub(endpoint).nfeAutorizacaoLote(dados, cabecalhoSOAP);
    ...
    private NfeAutorizacaoStub.NfeCabecMsgE getCabecalhoSOAP() {
        final NfeAutorizacaoStub.NfeCabecMsg cabecalho = new NfeAutorizacaoStub.NfeCabecMsg();
        cabecalho.setCUF(this.config.getCUF().getCodigoIbge());
        cabecalho.setVersaoDados(this.config.getVersao());
        final NfeAutorizacaoStub.NfeCabecMsgE cabecalhoSOAP = new NfeAutorizacaoStub.NfeCabecMsgE();
