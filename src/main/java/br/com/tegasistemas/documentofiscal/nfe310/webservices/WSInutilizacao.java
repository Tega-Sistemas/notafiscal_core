...
import br.com.tegasistemas.documentofiscal.nfe310.webservices.gerado.NfeInutilizacao2Stub;
import br.com.tegasistemas.documentofiscal.utils.DFAssinaturaDigital;
import br.com.tegasistemas.documentofiscal.nfe310.classes.evento.inutilizacao.NFEnviaEventoInutilizacao;
import br.com.tegasistemas.documentofiscal.nfe310.classes.evento.inutilizacao.NFEventoInutilizacaoDados;
...
class WSInutilizacao implements DFLog {
    ...
    private OMElement efetuaInutilizacao(final String inutilizacaoXMLAssinado, final DFModelo modelo) throws Exception {
        final NfeInutilizacao2Stub.NfeCabecMsg cabecalho = new NfeInutilizacao2Stub.NfeCabecMsg();
        cabecalho.setCUF(this.config.getCUF().getCodigoIbge());
        cabecalho.setVersaoDados(WSInutilizacao.VERSAO_SERVICO);
        
        final NfeInutilizacao2Stub.NfeCabecMsgE cabecalhoE = new NfeInutilizacao2Stub.NfeCabecMsgE();
        cabecalhoE.setNfeCabecMsg(cabecalho);
        
        final NfeInutilizacao2Stub.NfeDadosMsg dados = new NfeInutilizacao2Stub.NfeDadosMsg();
        ...
        final NfeInutilizacao2Stub.NfeInutilizacaoNF2Result nf2Result = new NfeInutilizacao2Stub(urlWebService).nfeInutilizacaoNF2(dados, cabecalhoE);
