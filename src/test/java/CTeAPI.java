...
public class CTeAPI {
    ...
    public String consultarSituacao(String chave, String xml) {
        ...
        if (!chave.isEmpty() && !chave.isEmpty()) {
            try {
                String retorno = new WSFacade(config).consultaNotaString(chave);
            ...
            logs = "Erro, dados informados estão incorretos! Favor verificar.";
        }
        return logs;
    }
