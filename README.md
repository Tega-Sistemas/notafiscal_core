...
## Atenção
Projeto de API para envio de notas fiscais, mdfe, cte, gnre e futuramente reinf baseado no repositório https://github.com/wmixvideo/nfe

## Instalação

### Diretamente pelo código fonte (última versão em desenvolvimento)
 ```console
    git clone https://github.com/pedrozampiroli/notafiscal_core
    utilizar meaven para compilar o projeto
    mvn clean install
  ```
